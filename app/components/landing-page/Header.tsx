    ...
    <header className="bg-[#1A1A1A] sticky top-0 z-50">
      <div className="container mx-auto px-4 md:px-6 py-4 md:py-5 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8 xl:gap-10 text-sm text-white">
          ...
          <a
            href="#contact"
            className="px-4 py-2 rounded-full border border-white/30 text-white hover:bg-white/10 transition"
          >
            Contact
          </a>
        ...
        <div className="lg:hidden bg-zinc-900 border-t border-zinc-800">
          <nav className="container mx-auto px-4 py-6 flex flex-col gap-4">
            <a
              ...
              className="text-white py-2 hover:text-amber-500 transition"
            >
              Services
            </a>
            <a
            ...
            <div className="flex flex-col gap-3 mt-4">
              <a
                href="#contact"
                onClick={closeMobileMenu}
                className="w-full text-center px-4 py-3 rounded-full border border-white/30 text-white hover:bg-white/10 transition"
              >
                Contact
              </a>
              <a
                href="#request"
                onClick={closeMobileMenu}
                className="w-full text-center px-4 py-3 rounded-full bg-amber-500 text-white font-semibold hover:bg-amber-600 transition"
              >
                Request
              </a>
            </div>
