    ...
    <section className="py-12 md:py-16 lg:py-24 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden flex flex-col lg:flex-row hover:shadow-2xl transition-shadow duration-300">
            {/* Text Left Half */}
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden flex flex-col hover:shadow-2xl transition-shadow duration-300">
            {/* Text Top */}
