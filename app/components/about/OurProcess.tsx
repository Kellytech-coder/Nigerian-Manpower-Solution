  ...
  return (
    <section className="bg-white py-10 px-6 md:px-12 lg:px-20">
      <div className="text-center mb-6">
        ...
        <p className="text-base text-gray-600 mt-1">Our Approach to Manpower Delivery</p>
      </div>

      {/* Row layout with reduced spacing and smaller cards */}
      <div className="flex flex-row flex-wrap justify-center gap-6">
        {processSteps.map((step, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center max-w-xs w-full sm:w-64"
          >
            <img
              src={step.imageSrc}
              alt={step.imageAlt}
            ...
            />
            <h3 className="text-md font-semibold text-gray-700 mb-1">{step.title}</h3>
